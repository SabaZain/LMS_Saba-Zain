...
def add_book(title, author, publication, genre, read_status):
    book = {
        'title': title,
        'author': author,
...
if st.session_state.current_view == "add":
    ...
    with st.form(key='add_book_form'):
        ...
        with col1:
            ...
            publication = st.number_input("publication_year", min_value=1000, max_value=datetime.now().year, step=1, value=2023)
        
        with col2:
            genre = st.selectbox("Genre", [
                "Science", "Technology", "Poetry", "Fantasy", "Friction", "Non-Friction", "History", "Art", "Religion", "Other"
            ])
        ...
        if submit_button and title and author:
            add_book(title,author,publication,genre,read_bool)
...
st.markdown("---")
st.markdown("Copyright @ 2025 Saba Ali Zain Personal Library Manager", unsafe_allow_html=True)
